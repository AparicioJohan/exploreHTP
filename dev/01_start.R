...
golem::fill_desc(
  ...
  authors = person(
    given = "Johan", # Your First Name
    family = "Aparicio", # Your Last Name
...
usethis::use_mit_license("Johan Aparicio") # You can set another license here
golem::use_readme_rmd(open = FALSE)
devtools::build_readme()
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Johan Aparicio")
